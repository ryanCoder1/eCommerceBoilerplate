...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        #footerEmail {
          margin-top: 25px;
          padding: 20px 0;
          border-top: solid thin rgb(219, 218, 219);
        ...
        <body>
          <table id="invoiceViewAnchor" class="invoice-view-table" border="0" >
            ...
            <tr class="invoice-tr-bg invoice-text-blue align-middle">
              ...
              <td colspan="2" class="td-styles invoice-text-blue text-left text-capitalize">
              ...
              <td colspan="3" class="td-width invoice-text-blue text-left text-capitalize">
            ...
            <tr class="border-bottom text-center">
              ...
              <th colspan="2" class="td-styles invoice-text-blue">Qty</th>
            ...
            <tr class="text-right">
              <td colspan="4" class="td-styles text-capitalize padding-x text-left">
          ...
          <div id="footerEmail">
            <small>
                  This email was sent to <strong> {{ $header->clientEmail }} </strong> as contact from <strong> {{ ucfirst($header->outfitName) }} </strong> using the Field Jobs Tracker app. <br/>
                  <strong>Please respond to {{ ucfirst($header->outfitName) }}'s contact information if needed.</strong><br/>
                  Field Jobs Tracker does not act as a liason between the parties involved.
            </small>
          </div>
        </body>
 </html>
